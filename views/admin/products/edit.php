...
<div class="max-w-full mx-auto">
    <div class="overflow-hidden">
        <div class="overflow-x-auto overscroll-x-auto flex flex-col gap-4">
            ...
            <form method="POST" action="/admin/products/<?= $product['slug_uuid'] ?>/update"
                enctype="multipart/form-data" class="bg-white p-5 rounded-none sm:rounded-xl border border-neutral-200">
                    ...
                    <div class="flex items-center justify-between border rounded-lg px-4 py-3 bg-gray-50">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                Disable this Product without deleting it
                            </p>
                        </div>
                        ...
                        <div id="imagesDropzone"
                            ...
                            <div class="images-preview hidden p-4">
                                <div class="flex flex-wrap gap-3" data-images-container>
                                    ...
                                    <!-- EXISTING IMAGES (server-rendered dari PHP) -->
                                    <?php foreach ($product['images'] ?? [] as $img): ?>
                                        <div class="relative group" data-existing-image="<?= htmlspecialchars($img) ?>">
                                            ...
                                            <!-- Hidden input: source of truth untuk existing images -->
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        <div class="relative z-40 flex flex-col gap-2" data-select>
                            ...
                            <button type="button" class="select-trigger w-full border rounded-lg py-2 px-3 text-sm
                                ...
                                <span
                                    class="select-label <?= $currentCategoryName ? 'text-gray-800' : 'text-gray-500' ?>">
                            ...
                            <input type="hidden" name="product_category_id"
                                value="<?= htmlspecialchars($product['product_category_id']) ?>" class="select-input"
                                required>
                        ...
                        <div class="relative z-40 flex flex-col gap-2" data-select>
                            ...
                            <button type="button" class="select-trigger w-full border rounded-lg py-2 px-3 text-sm
                                    flex justify-between items-center bg-neutral-50">
                                <span
                                    class="select-label <?= $currentGenderName ? 'text-gray-800' : 'text-gray-500' ?>">
                                    <?= $currentGenderName ?? 'Choose Gender' ?>
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 sm:gap-6">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="colors" required placeholder="Write Post Colors..."
                                value="<?= htmlspecialchars(implode(', ', $product['colors'] ?? [])) ?>"
                                class="w-full border text-sm tracking-tight rounded-lg px-3 py-2 bg-neutral-50 text-neutral-700 focus:ring-2 focus:ring-indigo-700 focus:outline-none">
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="size" required placeholder="Write Post Size..."
                                value="<?= htmlspecialchars(implode(', ', $product['sizes'] ?? [])) ?>"
                                class="w-full border text-sm tracking-tight uppercase rounded-lg px-3 py-2 bg-neutral-50 text-neutral-700 focus:ring-2 focus:ring-indigo-700 focus:outline-none">
                        </div>
