<?php
// views/admin/shipping-zones/create.php
$page_title = 'Add Shipping Zone';
ob_start();
?>
...
<div class="max-w-full mx-auto">
    <div class="flex flex-col gap-4">
        <div class="flex flex-col sm:flex-row gap-1 sm:gap-2 items-start sm:items-center px-6 sm:p-0">
            <h2 class="text-xl font-semibold text-gray-800 tracking-tight">Add Shipping Zone</h2>
            <p><?php breadcrumb(['Dashboard' => '/admin/dashboard', 'Shipping Zones' => '/admin/shipping-zones', 'Create' => null]); ?>
            </p>
        </div>
        ...
        <form method="POST" action="/admin/shipping-zones" enctype="multipart/form-data"
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="name" required placeholder="Jawa & Bali"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="kurir" required placeholder="JNE REG"
                            class="w-full border text-sm tracking-tight rounded-lg px-3 py-2 bg-neutral-50 text-neutral-700 focus:ring-2 focus:ring-indigo-700 focus:outline-none">
                    </div>
                    <div class="flex flex-col gap-2">
                        <label class="text-sm font-semibold">Ongkir (Rp) <span class="text-red-500">*</span></label>
                        <input type="number" name="cost" required placeholder="20000" min="0"
                            class="w-full border text-sm tracking-tight rounded-lg px-3 py-2 bg-neutral-50 text-neutral-700 focus:ring-2 focus:ring-indigo-700 focus:outline-none">
                    </div>
                </div>
                ...
                <!-- Icon Upload -->
                <div class="flex flex-col gap-2">
                    <label class="block text-sm font-semibold">Logo Kurir</label>
