        ...
        <ul class="space-y-2 font-normal mt-9 sm:mt-6 tracking-tight">
            ...
            <li>
                <a href="/admin/genders"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 transition-all duration-300 group-hover:text-indigo-400" aria-hidden="true">
                        <path stroke-width="2"
